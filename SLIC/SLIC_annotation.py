...
def SLIC_segmentation(image, num_superpixels=10, compactness=50):
...
def main(image_path):
    ...
    # Perform SLIC segmentation
    labels, mask, segmented_image = SLIC_segmentation(only_img)
...
if __name__ == "__main__":
    main('/home/sebastian/Documents/ANYmal_data/OPS_grass/odom_chosen_images_2/001718.png')
